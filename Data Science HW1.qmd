...
-   Question 1: Personally, I feel as though being a data scientist is about your ability to creatively problem solve and manage data to answer practical questions.
    -   It seems, based on the readings, that Statisticians are focused on modeling some pattern in observed data, while Data scientists are more focused on using models to find solutions to business problems.
